"""
Cerinta 3.6 - Wall-following: urmarirea peretelui din dreapta.
"""
import time
...
def main():
    ...
    sim.startSimulation()
    print(f"Wall-following pornit. Distanta tinta: {TARGET_DIST} m")
    ...
    try:
        while True:
            ...
            print(f"{state:<40} vS={v_left:+.2f} vD={v_right:+.2f}")
            time.sleep(0.05)
