"""
Cerinta 3.4 - Comportament reactiv simplu: oprire la obstacol.
"""
import time
...
def main():
    ...
    sim.startSimulation()
    print(f"Robot pornit. Oprire la obstacol < {STOP_DISTANCE} m.")
    ...
    try:
        while True:
            ...
            if dist_front < STOP_DISTANCE:
                ...
                print(f"[STOP] Obstacol la {dist_front:.3f} m")
            else:
